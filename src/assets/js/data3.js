export default {
  ...
  '河北省': {
    ...
    '邯郸市': ['邯山区', '丛台区', '复兴区', '峰峰矿区', '临漳县', '成安县', '大名县', '涉县', '磁县', '肥乡区', '永年区', '邱县', '鸡泽县', '广平县', '馆陶县', '魏县', '曲周县', '武安市'],
  ...
  '山西省': {
    ...
    '运城市': ['盐湖区', '永济市', '河津市', '芮城县', '临猗县', '万荣县', '新绛县', '稷山县', '闻喜县', '夏县', '平陆县', '垣曲县']
  },
  '内蒙古自治区': {
    ...
    '呼伦贝尔市': ['海拉尔区', '扎赉诺尔区', '满洲里市', '扎兰屯市', '牙克石市', '根河市', '额尔古纳市', '阿荣旗', '莫力达瓦达斡尔族自治旗', '鄂伦春自治旗', '鄂温克族自治旗', '新巴尔虎右旗', '新巴尔虎左旗', '陈巴尔虎旗'],
    ...
    '鄂尔多斯市': ['东胜区', '康巴什区', '达拉特旗', '准格尔旗', '鄂托克前旗', '鄂托克旗', '杭锦旗', '伊金霍洛旗', '乌审旗'],
  ...
  '黑龙江省': {
    '哈尔滨市': ['道里区', '南岗区', '道外区', '松北区', '香坊区', '阿城区', '平房区', '呼兰区', '双城区', '依兰县', '方正县', '宾县', '巴彦县', '木兰县', '通河县', '延寿县', '尚志市', '五常市'],
  ...
  '浙江省': {
    '杭州市': ['上城区', '下城区', '江干区', '拱墅区', '西湖区', '滨江区', '余杭区', '富阳区', '萧山市', '桐庐县', '淳安县', '建德市', '临安市'],
    ...
    '丽水市': ['莲都区', '龙泉市', '青田县', '云和县', '庆元县', '缙云县', '遂昌县', '松阳县', '景宁畲族自治县']
  },
  '安徽省': {
    '合肥市': ['包河区', '蜀山区', '庐阳区', '瑶海区', '庐江县', '长丰县', '肥东县', '肥西县', '巢湖市'],
    '芜湖市': ['镜湖区', '弋江区', '三山区', '鸠江区', '芜湖县', '繁昌县', '无为县', '南陵县'],
    '蚌埠市': ['龙子湖区', '蚌山区', '禹会区', '淮上区', '怀远县', '五河县', '固镇县'],
    '淮南市': ['大通区', '田家庵区', '谢家集区', '八公山区', '潘集区', '寿县', '凤台县'],
    '马鞍山市': ['博望区', '花山区', '雨山区', '和县', '含山县', '当涂县'],
    '淮北市': ['杜集区', '相山区', '烈山区', '濉溪县'],
    '铜陵市': ['铜官区', '义安区', '郊区', '枞阳县'],
  ...
  '山东省': {
    '济南市': ['历下区', '市中区', '槐荫区', '天桥区', '历城区', '长清区', '章丘区', '济阳县', '商河县', '平阴县'],
    ...
    '济宁市': ['兖州区', '任城区', '微山县', '鱼台县', '金乡县', '嘉祥县', '汶上县', '泗水县', '梁山县', '曲阜市', '邹城市'],
  ...
  '河南省': {
    ...
    '周口市': ['川汇区', '项城市', '扶沟县', '西华县', '商水县', '太康县', '鹿邑县', '郸城县', '淮阳县', '沈丘县'],
    '驻马店市': ['驿城区', '确山县', '泌阳县', '遂平县', '西平县', '上蔡县', '汝南县', '平舆县', '新蔡县', '正阳县'],
    '济源市': []
  },
  '湖北省': {
  ...
  '广东省': {
    ...
    '深圳市': ['罗湖区', '福田区', '南山区', '宝安区', '龙岗区', '龙华区', '坪山区', '盐田区'],
    '珠海市': ['香洲区', '斗门区', '金湾区'],
  ...
  '广西壮族自治区': {
    '南宁市': ['兴宁区', '青秀区', '西乡塘区', '江南区', '良庆区', '邕宁区', '武鸣区', '隆安县', '马山县', '上林县', '宾阳县', '横县'],
    '柳州市': ['城中区', '鱼峰区', '柳南区', '柳北区', '柳江县', '柳城县', '鹿寨县', '融安县', '融水苗族自治县', '三江侗族自治县'],
    '桂林市': ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜各族自治县', '资源县', '平乐县', '荔蒲县', '恭城瑶族自治县'],
    ...
    '百色市': ['右江区', '靖西市', '田阳县', '田东县', '平果县', '德保县', '那坡县', '凌云县', '乐业县', '田林县', '隆林各族自治县', '西林县'],
    '河池市': ['金城江区', '宜州区', '罗城仫佬族自治县', '环江毛南族自治县', '南丹县', '天峨县', '凤山县', '东兰县', '巴马瑶族自治县', '都安瑶族自治县', '大化瑶族自治县']
  },
  '海南省': {
    '琼北': ['琼海市', '文昌市', '万宁市', '定安县', '屯昌县', '澄迈县', '临高县'],
    '琼南': ['东方市', '五指山市', '白沙黎族自治县', '昌江黎族自治县', '乐东黎族自治县', '陵水黎族自治县', '保亭黎族苗族自治县', '琼中黎族苗族自治县'],
    '海口市': ['龙华区', '秀英区', '琼山区', '美兰区'],
    '三亚市': ['吉阳区', '崖州区', '天涯区', '海棠区'],
    '儋州市': ['儋州市'],
    '三沙市': ['三沙市'],
  ...
  '四川省': {
    '成都市': ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '温江区', '新都区', '双流区', '郫都区', '金堂县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市', '简阳市'],
    '自贡市': ['自流井区', '贡井区', '大安区', '沿滩区', '荣县', '富顺县'],
    '攀枝花市': ['东区', '西区', '仁和区', '米易县', '盐边县'],
    '泸州市': ['江阳区', '纳溪区', '龙马潭区', '泸县', '合江县', '叙永县', '古蔺县'],
    '德阳市': ['旌阳区', '中江县', '罗江县', '广汉市', '什邡市', '绵竹市'],
    '绵阳市': ['涪城区', '游仙区', '三台县', '盐亭县', '安州区', '梓潼县', '北川羌族自治县', '平武县', '江油市'],
    ...
    '达州市': ['达川区', '通川区', '宣汉县', '开江县', '大竹县', '渠县', '万源市'],
    '雅安市': ['雨城区', '名山区', '荥经县', '汉源县', '石棉县', '天全县', '芦山县', '宝兴县'],
    '阿坝藏族羌族自治州': ['汶川县', '理县', '茂县', '松潘县', '九寨沟县', '金川县', '小金县', '黑水县', '马尔康市', '壤塘县', '阿坝县', '若尔盖县', '红原县'],
  ...
  '云南省': {
    '昆明市': ['五华区', '盘龙区', '官渡区', '西山区', '东川区', '呈贡区', '晋宁区', '富民县', '宜良县', '石林彝族自治县', '嵩明县', '禄劝彝族苗族自治县', '寻甸回族自治县', '安宁市'],
    ...
    '红河哈尼族彝族自治州': ['个旧市', '开远市', '蒙自市', '屏边苗族自治县', '建水县', '石屏县', '弥勒市', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县'],
  ...
  '西藏自治区': {
    ...
    '山南市': ['乃东县', '扎囊县', '贡嘎县', '桑日县', '琼结县', '曲松县', '措美县', '洛扎县', '加查县', '隆子县', '错那县', '浪卡子县'],
    '日喀则市': ['桑珠孜区', '南木林县', '江孜县', '定日县', '萨迦县', '拉孜县', '昂仁县', '谢通门县', '白朗县', '仁布县', '康马县', '定结县', '仲巴县', '亚东县', '吉隆县', '聂拉木县', '萨嘎县', '岗巴县'],
    '那曲市': ['那曲县', '嘉黎县', '比如县', '聂荣县', '安多县', '申扎县', '索县', '班戈县', '双湖县', '巴青县', '尼玛县'],
    '阿里地区': ['普兰县', '札达县', '噶尔县', '日土县', '革吉县', '改则县', '措勤县'],
    '林芝市': ['巴宜区', '工布江达县', '米林县', '墨脱县', '波密县', '察隅县', '朗县']
  },
  '陕西省': {
    '西安市': ['新城区', '碑林区', '莲湖区', '灞桥区', '未央区', '雁塔区', '阎良区', '临潼区', '长安区', '高陵区', '鄠邑区', '周至县', '蓝田县'],
    '铜川市': ['王益区', '印台区', '耀州区', '宜君县'],
    ...
    '延安市': ['宝塔区', '安塞区', '延长县', '延川县', '子长县', '志丹县', '吴旗县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县'],
  ...
  '新疆维吾尔自治区': {
    ...
    '伊犁哈萨克自治州': ['奎屯市', '霍尔果斯市', '伊宁市', '伊宁县', '察布查尔锡伯自治县', '霍城县', '巩留县', '新源县', '昭苏县', '特克斯县', '尼勒克县'],
